        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <form className="bg-surface p-8 rounded-lg shadow-md space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input id="fullName" name="fullName" type="text" value={formData.fullName} onChange={handleChange} className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm  bg-surface focus:ring-primary focus:border-primary" />
                </div>
                <div>
                    <label htmlFor="email" className="block  text-sm font-medium text-textSecondary">{t('editProfile.email')}</label>
                    <input id="email" name="email" type="email" value={formData.email} disabled className="w-full px-3 py-2 mt-1 border  rounded-md shadow-sm bg-surface" />
                </div>
                <div>
                    <label htmlFor="bio" className="block text-sm font-medium text-textSecondary">{t('editProfile.bio')}</label>
                    <textarea id="bio" name="bio" rows="4" value={formData.bio} onChange={handleChange} className="w-full px-3 py-2 mt-1 border border-gray-300 bg-surface rounded-md shadow-sm focus:ring-primary focus:border-primary"></textarea>
                </div>

                <div className="border-t pt-6">
                    <h3 className="text-xl font-semibold mb-4">{t('editProfile.uiLanguage')}</h3>
                    <select value={preferredLanguage} onChange={handleLanguageChange} className="w-full px-3 py-2 mt-1 border bg-surface border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary">
                ...
                <div className="border-t pt-6">
                    ...
                    <div className="flex mt-1">
                        <select value={languageToAdd} onChange={(e) => setLanguageToAdd(e.target.value)} className="w-full px-3 py-2 border bg-surface border-gray-300 rounded-l-md shadow-sm focus:ring-primary focus:border-primary">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                        {languagesSpoken.map(lang => (
                            <span key={lang} className="bg-primary text-textPrimary px-3 py-1 rounded-full text-sm flex items-center">
                                {lang}
                ...
                <div className="border-t pt-6">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex mt-1">
                            <input id="teach-skills" list="topics-list" value={teachInput} onChange={(e) => setTeachInput(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-l-md bg-surface shadow-sm focus:ring-primary focus:border-primary" />
                    ...
                    <div>
                        ...
                        <div className="flex mt-1">
                            <input id="learn-skills" list="topics-list" value={learnInput} onChange={(e) => setLearnInput(e.target.value)} className="w-full px-3 py-2 border bg-surface border-gray-300 rounded-l-md shadow-sm focus:ring-primary focus:border-primary" />
